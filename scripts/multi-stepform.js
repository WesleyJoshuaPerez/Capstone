document.addEventListener("DOMContentLoaded", function () {
  ...
  const installationTime = document.getElementById("installation-time");
  ...
  function validateFinalStep(event) {
    ...
    if (installationTime && installationTime.value.trim() === "") {
      event.preventDefault();
      Swal.fire({
        icon: "error",
        title: "Installation Time Required",
        text: "Please select an installation time before submitting.",
      });
      return false;
    }
