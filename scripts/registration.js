...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!subscriptionSelect || !pricingBox || !planTitle || !planPrice || !planDetails) {
        console.error("🚨 One or more required elements not found. Check your IDs.");
        return;
    }
    ...
    function updatePlanUI() {
        ...
        console.log(`🔄 Updating pricing box for: ${selectedPlan}`);
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!municipalitySelect || !barangaySelect) {
        console.error("🚨 Municipality or Barangay dropdown not found. Check HTML IDs.");
        return;
    }
