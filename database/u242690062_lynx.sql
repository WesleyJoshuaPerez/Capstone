...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 18, 2025 at 01:28 PM
...
('0000000002', 'AKrezada202', '482c811da5d5b4bc6d497ffa98491e38', 'Gold', 1799, NULL, 'unpaid', 'ANGELINE KATE REZADA', '2003-11-20', 'wawa, Orion, Bataan', '0905-462-7399', 'katerezada0120@gmail.com', 'Postal-ID', '', 'id_picture.png', 'id_picture.png', 'Rented', '2025-05-27', '2025-05-12', 14.623204, 120.583979, '0000000005'),
('0000000003', 'WJperez173', '4bb2cf5da3d720b960917855aeb9ed7d', 'Gold', 1799, '2025-07-07', 'unpaid', 'WESLEY JOSHUA PEREZ', '2004-03-17', 'bilolo, Orion, Bataan', '0912-868-9551', 'wesleyjoshuaperez.iskolar@gmail.com', 'Drivers-License', '', 'id.png', 'A2.jpg', 'Owned', '2025-05-17', '2025-05-12', 14.612382, 120.561901, '0000000001'),
('0000000004', 'Aheramis074', 'ec53253155cfb518af076a612bf16301', 'Silver', 0, '2025-07-18', 'paid', 'APRIL HERAMIS', '2007-05-07', 'sabatan, Orion, Bataan', '0934-897-3489', 'perezwesley17@gmail.com', 'Drivers-License', '', 'testid.jpg', 'gcash.png', 'Rented', '2025-05-26', '2025-05-14', 14.615030, 120.568467, '0000000004'),
('0000000005', 'Tmendoza045', '84a2c5dd30a4d777aeb1cd251c61e9d7', 'Silver', 1499, '2025-06-29', 'unpaid', 'TROY MENDOZA', '2007-06-04', 'sabatan, Orion, Bataan', '0923-929-3872', 'sojori6529@finfave.com', 'Drivers-License', '0312123456', 'gundam.png', 'wallpaper.jpg', 'Rented', '2025-07-11', '2025-06-23', 14.614992, 120.567946, '0000000004');
...
(6, '0000000003', 'WESLEY JOSHUA PEREZ', '0912-868-9551', 'bilolo, Orion, Bataan', 'Frequent Disconnections', 'Testing on live domain', 'Morning (8AM - 12PM)', '1721110120440.jpg', '2025-07-11 01:05:57', 'Pending', NULL),
...
(8, '0000000002', 'ANGELINE KATE REZADA', '0905-462-7399', 'wawa, Orion, Bataan', 'No Internet Connection', 'no internet connection', 'Morning (8AM - 12PM)', '', '2025-07-18 12:10:55', 'Ongoing', NULL);
...
('0000000001', 'BILOLO-POST1', 14, 120.562312, 14.612766, 'Enabled'),
...
(20, '0000000004', 'APRIL HERAMIS', 'Silver', 'Onsite', 0.00, 1499.00, '2025-07-18 19:52:48', 'REF687A359057670', 'Onsite Payment', 'Paid', NULL);
...
--
ALTER TABLE `resetpass_request`
  MODIFY `resetpass_request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
